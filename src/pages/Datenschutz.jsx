  ...
  return (
    <div className="min-h-screen bg-black text-white p-8 md:p-20 font-mono">
      ...
      <div className="space-y-8 text-gray-300 max-w-2xl leading-relaxed text-sm md:text-base">
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-2">4. Kontaktaufnahme</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-2">5. Ihre Betroffenenrechte</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-2">6. Beschwerderecht</h2>
          <p>
